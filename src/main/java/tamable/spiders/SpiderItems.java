...
public class SpiderItems {
	...
	public static final DeferredItem<Item> GoldenArmor = registerItem("golden_spider_armor", (properties) -> new SpiderArmorItem(ArmorMaterials.CHAIN, SpiderArmorItem.BodyType.Ordinary, properties), new Item.Properties().stacksTo(1));
