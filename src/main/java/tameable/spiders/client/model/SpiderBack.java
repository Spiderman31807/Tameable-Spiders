...
public class SpiderBack<AgeableSpider extends Entity> extends HierarchicalModel<AgeableSpider> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("tameable_spiders", "spider_back"), "main");
	public final ModelPart neck;
	public final ModelPart body;
	public final ModelPart saddle;
	public final ModelPart saddleSide;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition saddleSide = saddle.addOrReplaceChild("saddle_side",
